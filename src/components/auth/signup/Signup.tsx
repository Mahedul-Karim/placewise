  ...
  return (
    <div className="bg-white px-4 py-6 rounded-md shadow-sm w-full sm:w-[400px] flex flex-col gap-3">
      ...
      <Img
        ...
        rounded
        />
        <label className="w-[40px] h-[40px] border border-solid border-border flex items-center justify-center cursor-pointer rounded-md" htmlFor="image__upload"><FaCloudUploadAlt size={25}/></label>
      <input type="file" id="image__upload" className="hidden"/>
        </div>
      <p>
        Already have an account?{" "}
        <span className="text-primary font-[600] cursor-pointer">Login</span>
      </p>
